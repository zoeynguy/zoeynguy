...
insert into Account(UserName, DisplayName, Password, TypeID)
values ('chinh', 'Nhân viên (Kieu Chinh)' ,'12345', 2)
go

insert into Account(UserName, DisplayName, Password, TypeID)
values ('hoan', 'Nhân viên (Dinh Hoan)' ,'12345', 2)
go


insert into Account(UserName, DisplayName, Password, TypeID)
values ('cohang', 'Nhân viên (cô hằng)' ,'12345', 2)
go
insert into Account(UserName, DisplayName, Password, TypeID)
values ('chucuoi', 'Nhân viên (chucuoi)' ,'12345', 2)
go
